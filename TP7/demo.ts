...
/* TODO 1: Symbol Table
    * Create a type for the Symbol Table
    * Each element of the symbol table should have a type and a value
    * Define the symbol_table variable; an entry should look like this : "_var1" : {"type": "string", "value": "ALF"}
    * Complete the function that will add the variable to the symbol table
*/
...
/* TODO 2: Create a function that will check if a variable was already defined in the Symbol Table */
...
/** TODO 3: Check if the types of the value nodes of an expression's operands are matching
  ...
  * Hint: For each left and right member of an expression, if their AST type is 'variable', you should check the type marked in the symbol table
*/
